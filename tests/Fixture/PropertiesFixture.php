...
class PropertiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'presentation' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => 1528073447,
                'updated_at' => 1528073447
            ],
        ];
        parent::init();
    }
